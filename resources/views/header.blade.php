      ...
      <section>
        <nav>
          <ul>
            ...
            <li> <a style="text-decoration: none; color : black"  href="list-task"> List Of Pending Task </a></li>
            <li> <a style="text-decoration: none; color : black"  href="list-task"> List Of Completed Tasks </a></li>
          </ul>
        </nav>